...
`timescale 1 ps / 1 ps
module nios_mcu_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                              //                            clk_0_clk.clk
		input  wire        nios_cpu_reset_reset_bridge_in_reset_reset, // nios_cpu_reset_reset_bridge_in_reset.reset
		input  wire [15:0] nios_cpu_data_master_address,               //                 nios_cpu_data_master.address
		...
		input  wire [15:0] nios_cpu_instruction_master_address,        //          nios_cpu_instruction_master.address
		...
		output wire [12:0] onchip_ram_s2_address,                      //                        onchip_ram_s2.address
	...
	wire  [15:0] nios_cpu_data_master_translator_avalon_universal_master_0_address;              // nios_cpu_data_master_translator:uav_address -> nios_cpu_data_master_agent:av_address
	...
	wire   [4:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> nios_cpu_data_master_agent:rp_channel
	...
	wire  [15:0] nios_cpu_instruction_master_translator_avalon_universal_master_0_address;       // nios_cpu_instruction_master_translator:uav_address -> nios_cpu_instruction_master_agent:av_address
	...
	wire   [4:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> nios_cpu_instruction_master_agent:rp_channel
	...
	wire  [15:0] nios_cpu_debug_mem_slave_agent_m0_address;                                      // nios_cpu_debug_mem_slave_agent:m0_address -> nios_cpu_debug_mem_slave_translator:uav_address
	...
	wire   [4:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> nios_cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [91:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [15:0] onchip_ram_s2_agent_m0_address;                                                 // onchip_ram_s2_agent:m0_address -> onchip_ram_s2_translator:uav_address
	...
	wire  [92:0] onchip_ram_s2_agent_rf_source_data;                                             // onchip_ram_s2_agent:rf_source_data -> onchip_ram_s2_agent_rsp_fifo:in_data
	...
	wire  [92:0] onchip_ram_s2_agent_rsp_fifo_out_data;                                          // onchip_ram_s2_agent_rsp_fifo:out_data -> onchip_ram_s2_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                          // cmd_mux_003:src_valid -> onchip_ram_s2_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> onchip_ram_s2_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                          // onchip_ram_s2_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> onchip_ram_s2_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                  // cmd_mux_003:src_startofpacket -> onchip_ram_s2_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                    // cmd_mux_003:src_endofpacket -> onchip_ram_s2_agent:cp_endofpacket
	...
	wire  [92:0] onchip_ram_s1_agent_rf_source_data;                                             // onchip_ram_s1_agent:rf_source_data -> onchip_ram_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] onchip_ram_s1_agent_rsp_fifo_out_data;                                          // onchip_ram_s1_agent_rsp_fifo:out_data -> onchip_ram_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> onchip_ram_s1_agent:cp_data
	...
	wire  [91:0] pio_0_s1_agent_rp_data;                                                         // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire         onchip_ram_s2_agent_rp_valid;                                                   // onchip_ram_s2_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] onchip_ram_s2_agent_rp_data;                                                    // onchip_ram_s2_agent:rp_data -> router_005:sink_data
	wire         onchip_ram_s2_agent_rp_ready;                                                   // router_005:sink_ready -> onchip_ram_s2_agent:rp_ready
	wire         onchip_ram_s2_agent_rp_startofpacket;                                           // onchip_ram_s2_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         onchip_ram_s2_agent_rp_endofpacket;                                             // onchip_ram_s2_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [91:0] onchip_ram_s1_agent_rp_data;                                                    // onchip_ram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [91:0] cmd_demux_001_src1_data;                                                        // cmd_demux_001:src1_data -> cmd_mux_004:sink0_data
	...
	wire  [91:0] rsp_demux_004_src0_data;                                                        // rsp_demux_004:src0_data -> rsp_mux_001:sink1_data
	...
	wire         onchip_ram_s2_agent_rdata_fifo_src_valid;                                       // onchip_ram_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] onchip_ram_s2_agent_rdata_fifo_src_data;                                        // onchip_ram_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         onchip_ram_s2_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> onchip_ram_s2_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                              // avalon_st_adapter_003:out_0_valid -> onchip_ram_s2_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                               // avalon_st_adapter_003:out_0_data -> onchip_ram_s2_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                              // onchip_ram_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                              // avalon_st_adapter_003:out_0_error -> onchip_ram_s2_agent:rdata_fifo_sink_error
	...
	nios_mcu_mm_interconnect_0_router router (
	...
	nios_mcu_mm_interconnect_0_router_001 router_001 (
	...
	nios_mcu_mm_interconnect_0_router_002 router_002 (
	...
	nios_mcu_mm_interconnect_0_router_003 router_003 (
	...
	nios_mcu_mm_interconnect_0_router_002 router_004 (
	...
	nios_mcu_mm_interconnect_0_router_002 router_005 (
	...
	nios_mcu_mm_interconnect_0_router_006 router_006 (
	...
	nios_mcu_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (nios_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mcu_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
